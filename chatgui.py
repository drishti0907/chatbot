...
intents = json.loads(open('E:\study\minor project\intents.json').read())

# loading the words , classes and model file
words = pickle.load(open('E:\study\minor project\words.pkl', 'rb'))
classes = pickle.load(open('E:\study\minor project\classes.pkl', 'rb'))
model = load_model('E:\study\minor project\chatbot_model.h5')
