...
pickle.dump(words, open('E:\study\minor project\words.pkl', 'wb'))
pickle.dump(classes, open('E:\study\minor project\classes.pkl', 'wb'))
...
model.save('E:\study\minor project\chatbot_model.h5', hist)
